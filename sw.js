 ...
 */
const BUILD = 'd579c595c7'; /*__BUILD__*/
const DATA_VERSION = '9a19888a6b'; /*__DATA__*/
const APP_SHELL = ["./","./index.html","./manifest.webmanifest","./assets/index-BNP_Gmkt.js","./assets/index-DijT58i_.css","./icons/apple-touch-icon.png","./icons/favicon-32.png","./icons/icon-192.png","./icons/icon-512.png","./icons/icon-maskable-512.png"]; /*__SHELL__*/
